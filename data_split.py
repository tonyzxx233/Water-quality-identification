...
def data_set_split(src_data_folder, target_data_folder, train_scale=0.6, val_scale=0.2, test_scale=0.2):
    ...
    :param src_data_folder: 源文件夹 E:/PycharmProjects/pythonProject/image/water_data
    :param target_data_folder: 目标文件夹 E:/PycharmProjects/pythonProject/image/water_data_split
...
if __name__ == '__main__':
    src_data_folder = "./image/water_data"
